      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <ul>
              <li><strong>Denominación social:</strong> Arjé Partners</li>
            ...
            <p>
              ...
              LA WEB), del que es titular Arjé Partners.
            </p>
            <p>
            ...
            <p>
              El usuario se compromete a hacer un uso adecuado de los contenidos y servicios que Arjé Partners
            ...
            <p>
              Arjé Partners es titular de todos los derechos de propiedad intelectual e industrial de LA WEB,
            ...
            <p>
              ...
              medio técnico, sin la autorización de Arjé Partners.
            </p>

            <h2>5. Exclusión de Garantías y Responsabilidad</h2>
            <p>
              Arjé Partners no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier
            ...
            <p>
              Arjé Partners se reserva el derecho de efectuar sin previo aviso las modificaciones que considere
            ...
            <p>
              ...
              Arjé Partners no ejercerá ningún tipo de control sobre dichos sitios y contenidos. En ningún caso
              Arjé Partners asumirá responsabilidad alguna por los contenidos de algún enlace perteneciente a un
            ...
            <p>
              Arjé Partners se reserva el derecho a denegar o retirar el acceso a LA WEB y/o los servicios
            ...
            <p>
              Arjé Partners perseguirá el incumplimiento de las presentes condiciones así como cualquier
            ...
            <p>
              La relación entre Arjé Partners y el usuario se regirá por la normativa española vigente y
              cualquier controversia se someterá a los Juzgados y Tribunales de la ciudad de [Ciudad].
            </p>
